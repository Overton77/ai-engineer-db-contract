---
id: "rel:corpus.funding_round"
kind: table
schema: corpus
name: funding_round
domain: identity
aliases: []
tokens: [corpus, funding_round, corpus.funding_round, id, tenant_id, kind, round_kind, announced_on, currency]
summary: null
summary_basis: none
rls: enabled
readers: [control_plane, executor_service, pipeline_agent, service_role, verifier_agent]
writers: [executor_service, service_role]
typescript: "Database[\"corpus\"][\"Tables\"][\"funding_round\"][\"Row\"]"
defined_in: ["20260912010200_km_02_corpus_identity.sql"]
workspace_fingerprint: "sha256:b0b1edb4bb695c5b199c50ded01dfd5e79e272140d5c133893b4a1a6f008c4c2"
---
# corpus.funding_round
...
| 3 | `kind` | `text` | no | `'funding_round'::text` | — |
| 4 | `round_kind` | `text` | yes | — | — |
...
- PK (id)
- unique (tenant_id, id)
- check `funding_round_kind_check`: `(kind = 'funding_round'::text)`
...
`funding_round_tenant_id_id_key` unique
...
insert: `Database["corpus"]["Tables"]["funding_round"]["Insert"]`; row: `Database["corpus"]["Tables"]["funding_round"]["Row"]`; update: `Database["corpus"]["Tables"]["funding_round"]["Update"]`
