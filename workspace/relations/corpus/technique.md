---
id: "rel:corpus.technique"
kind: table
schema: corpus
name: technique
domain: identity
aliases: []
tokens: [corpus, technique, corpus.technique, id, tenant_id, kind, technique_kind, description]
summary: null
summary_basis: none
rls: enabled
readers: [control_plane, executor_service, pipeline_agent, service_role, verifier_agent]
writers: [executor_service, service_role]
typescript: "Database[\"corpus\"][\"Tables\"][\"technique\"][\"Row\"]"
...
| 3 | `kind` | `text` | no | `'technique'::text` | — |
| 4 | `technique_kind` | `text` | yes | — | — |
...
- PK (id)
- unique (tenant_id, id)
- check `technique_kind_check`: `(kind = 'technique'::text)`
...
`technique_tenant_id_id_key` unique
...
insert: `Database["corpus"]["Tables"]["technique"]["Insert"]`; row: `Database["corpus"]["Tables"]["technique"]["Row"]`; update: `Database["corpus"]["Tables"]["technique"]["Update"]`
