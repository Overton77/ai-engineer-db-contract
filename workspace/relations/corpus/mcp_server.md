---
id: "rel:corpus.mcp_server"
kind: table
schema: corpus
name: mcp_server
domain: identity
aliases: []
tokens: [corpus, mcp_server, corpus.mcp_server, id, tenant_id, kind, transport, description]
summary: null
summary_basis: none
rls: enabled
readers: [control_plane, executor_service, pipeline_agent, service_role, verifier_agent]
writers: [executor_service, service_role]
typescript: "Database[\"corpus\"][\"Tables\"][\"mcp_server\"][\"Row\"]"
...
| 3 | `kind` | `text` | no | `'mcp_server'::text` | — |
| 4 | `transport` | `text[]` | yes | — | — |
...
`mcp_server_tenant_id_id_key` unique
...
insert: `Database["corpus"]["Tables"]["mcp_server"]["Insert"]`; row: `Database["corpus"]["Tables"]["mcp_server"]["Row"]`; update: `Database["corpus"]["Tables"]["mcp_server"]["Update"]`
