...
domain: identity
aliases: []
tokens: [corpus, story, corpus.story, id, tenant_id, kind, title, canonical_url, published_at]
summary: null
summary_basis: none
rls: enabled
readers: [control_plane, executor_service, pipeline_agent, service_role, verifier_agent]
writers: [executor_service, service_role]
typescript: "Database[\"corpus\"][\"Tables\"][\"story\"][\"Row\"]"
...
- PK (id)
- unique (tenant_id, id)
- check `story_kind_check`: `(kind = 'story'::text)`
...
insert: `Database["corpus"]["Tables"]["story"]["Insert"]`; row: `Database["corpus"]["Tables"]["story"]["Row"]`; update: `Database["corpus"]["Tables"]["story"]["Update"]`
