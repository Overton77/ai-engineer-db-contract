---
id: "rel:corpus.agent_skill"
kind: table
schema: corpus
name: agent_skill
domain: identity
aliases: []
tokens: [corpus, agent_skill, corpus.agent_skill, id, tenant_id, kind, skill_format, description]
summary: null
summary_basis: none
rls: enabled
readers: [control_plane, executor_service, pipeline_agent, service_role, verifier_agent]
writers: [executor_service, service_role]
typescript: "Database[\"corpus\"][\"Tables\"][\"agent_skill\"][\"Row\"]"
...
| 3 | `kind` | `text` | no | `'agent_skill'::text` | — |
| 4 | `skill_format` | `text` | yes | — | — |
...
- PK (id)
- unique (tenant_id, id)
- check `agent_skill_kind_check`: `(kind = 'agent_skill'::text)`
...
`agent_skill_tenant_id_id_key` unique
...
insert: `Database["corpus"]["Tables"]["agent_skill"]["Insert"]`; row: `Database["corpus"]["Tables"]["agent_skill"]["Row"]`; update: `Database["corpus"]["Tables"]["agent_skill"]["Update"]`
